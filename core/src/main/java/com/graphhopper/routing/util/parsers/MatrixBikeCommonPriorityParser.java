...
public abstract class MatrixBikeCommonPriorityParser implements TagParser {
    ...
    protected MatrixBikeCommonPriorityParser(DecimalEncodedValue priorityEnc, DecimalEncodedValue avgSpeedEnc,
                                             EnumEncodedValue<RouteNetwork> bikeRouteEnc) {
