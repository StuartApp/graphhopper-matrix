...
public abstract class MatrixBikeCommonAccessParser extends AbstractAccessParser implements TagParser {
    ...
    protected MatrixBikeCommonAccessParser(BooleanEncodedValue accessEnc, BooleanEncodedValue roundaboutEnc) {
